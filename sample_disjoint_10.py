...
def olken_sample_from_disjoint(js, n, hss):
    ...
    f = open("./tpch_10_chain_5/olkens_weights.pkl","wb")
    pickle.dump(ws,f)
    f.close()

    print("successfully stored")
    
    # ws = pickle.load(open("./tpch_10_chain_5/olkens_weights.pkl", "rb"))
...
def exact_sample_from_disjoint(js, n, hss):
    ...
    f = open("./tpch_10_chain_5/exact_weights.pkl","wb")
    pickle.dump(ws,f)
    f.close()

    print("successfully stored")
    
    # ws = pickle.load(open("./tpch_10_chain_5/exact_weights.pkl", "rb"))
    # print("weights successfully loaded")
