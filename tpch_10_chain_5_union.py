...
def main():
    ...
    # print(exact_time)
    # exact_S.to_csv(r'./tpch_10_chain_5/exact_sample_1000000.csv')
    # with open('./tpch_10_chain_5/exact_time_1000000.txt', 'w') as f:
    ...
    # print(olken_time)
    # olken_S.to_csv(r'./tpch_10_chain_5/olken_sample_1000000.csv')
    # with open('./tpch_10_chain_5/olken_time_1000000.txt', 'w') as f:
    ...
    olken_u_b_S.to_csv(r'./tpch_10_chain_5/olken_b_10000.csv')
    ...
    exact_u_b_S.to_csv(r'./tpch_10_chain_5/exact_b_10000.csv')
