...
def main():
    ...
    # hs_2_pri = hash_j_uq3(join_2, ['CustKey', 'CustKey', 'SuppKey', 'SuppKey', 'OrderKey'])
    # print("Hash success")
    ...
    exact_u_b_S, exact_u_b_time = exact_olken_sample_union_bernoulli([join_1, join_2, join_3], n, [hs_1, hs_2, hs_3], [norm_join_1, norm_join_2, norm_join_3])
    print(exact_u_b_time)
    exact_u_b_S.to_csv(r'./uq3_3_3/exact_b_10000.csv')
    with open('./uq3_3_3/exact_b_time_10000.txt', 'w') as f:
