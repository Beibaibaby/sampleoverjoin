...
def main():
    ...
    hs_1 = hash_j_uq3(join_1, ['SuppKey', 'CustKey', 'OrderKey'])
    print("Hash success")
    ...
    hs_2 = hash_j_uq3(join_2, ['CustKey', 'CustKey', 'SuppKey', 'SuppKey', 'OrderKey'])
    print("Hash success")
    ...
    hs_3 = hash_j_uq3(join_3, ['SuppKey', 'CustKey', 'OrderKey', 'OrderKey'])
    print("Hash success")
    ...
    e_union = uq3_calc_U([join_1, join_2, join_3], [norm_join_1, norm_join_2, norm_join_3])
    ...
    print(exact_time)
    exact_S.to_csv(r'./uq3_3_3/exact_sample_10000.csv')
    with open('./uq3_3_3/exact_time_10000.txt', 'w') as f:
        f.write(json.dumps(exact_time))


    # olken_S, olken_time = olken_sample_from_disjoint([join_1, join_2, join_3], n, [hs_1, hs_2, hs_3])
    # print(olken_time)
    # olken_S.to_csv(r'./uq3_3_3/olken_sample_10000.csv')
    # with open('./uq3_3_3/olken_time_10000.txt', 'w') as f:
    ...
    # olken_u_b_S.to_csv(r'./uq3_3_3/olken_u_b_sample_10000.csv')
    # with open('./uq3_3_3/olken_u_b_time_10000.txt', 'w') as f:
    ...
    # exact_u_b_S.to_csv(r'./uq3_3_3/exact_u_b_sample_10000.csv')
    # with open('./uq3_3_3/exact_u_b_time_10000.txt', 'w') as f:
