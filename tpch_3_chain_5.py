...
def main():
    ...
    # nation_sample_1.to_csv(r'./tpch_3_chain_5/n1.csv')
    # supplier_sample_1.to_csv(r'./tpch_3_chain_5/s1.csv')
    # customer_sample_1.to_csv(r'./tpch_3_chain_5/c1.csv')
    # orders_sample_1.to_csv(r'./tpch_3_chain_5/o1.csv')
    # lineitem_sample_1.to_csv(r'./tpch_3_chain_5/l1.csv')
    ...
    # nation_sample_2.to_csv(r'./tpch_3_chain_5/n2.csv')
    # supplier_sample_2.to_csv(r'./tpch_3_chain_5/s2.csv')
    # customer_sample_2.to_csv(r'./tpch_3_chain_5/c2.csv')
    # orders_sample_2.to_csv(r'./tpch_3_chain_5/o2.csv')
    # lineitem_sample_2.to_csv(r'./tpch_3_chain_5/l2.csv')
    ...
    # nation_sample_3.to_csv(r'./tpch_3_chain_5/n3.csv')
    # supplier_sample_3.to_csv(r'./tpch_3_chain_5/s3.csv')
    # customer_sample_3.to_csv(r'./tpch_3_chain_5/c3.csv')
    # orders_sample_3.to_csv(r'./tpch_3_chain_5/o3.csv')
    # lineitem_sample_3.to_csv(r'./tpch_3_chain_5/l3.csv')
    ...
    # nation_sample_4.to_csv(r'./tpch_3_chain_5/n4.csv')
    # supplier_sample_4.to_csv(r'./tpch_3_chain_5/s4.csv')
    # customer_sample_4.to_csv(r'./tpch_3_chain_5/c4.csv')
    # orders_sample_4.to_csv(r'./tpch_3_chain_5/o4.csv')
    # lineitem_sample_4.to_csv(r'./tpch_3_chain_5/l4.csv')
    ...
    # nation_sample_5.to_csv(r'./tpch_3_chain_5/n5.csv')
    # supplier_sample_5.to_csv(r'./tpch_3_chain_5/s5.csv')
    # customer_sample_5.to_csv(r'./tpch_3_chain_5/c5.csv')
    # orders_sample_5.to_csv(r'./tpch_3_chain_5/o5.csv')
    # lineitem_sample_5.to_csv(r'./tpch_3_chain_5/l5.csv')
    ...
    # nation_sample_4 = pd.read_csv('./tpch_3_chain_5/n4.csv' ,index_col=0)
    # supplier_sample_4 = pd.read_csv('./tpch_3_chain_5/s4.csv' ,index_col=0)
    # customer_sample_4 = pd.read_csv('./tpch_3_chain_5/c4.csv' ,index_col=0)
    # orders_sample_4 = pd.read_csv('./tpch_3_chain_5/o4.csv' ,index_col=0)
    # lineitem_sample_4 = pd.read_csv('./tpch_3_chain_5/l4.csv' ,index_col=0)

    # nation_sample_5 = pd.read_csv('./tpch_3_chain_5/n5.csv' ,index_col=0)
    # supplier_sample_5 = pd.read_csv('./tpch_3_chain_5/s5.csv' ,index_col=0)
    # customer_sample_5 = pd.read_csv('./tpch_3_chain_5/c5.csv' ,index_col=0)
    # orders_sample_5 = pd.read_csv('./tpch_3_chain_5/o5.csv' ,index_col=0)
    # lineitem_sample_5 = pd.read_csv('./tpch_3_chain_5/l5.csv' ,index_col=0)
    ...
    # f = open("./tpch_3_chain_5/q1_hs.pkl","wb")
    # pickle.dump(hs_1,f)
    # f.close()
    ...
    # f = open("./tpch_3_chain_5/q2_hs.pkl","wb")
    # pickle.dump(hs_2,f)
    # f.close()
    ...
    # f = open("./tpch_3_chain_5/q3_hs.pkl","wb")
    # pickle.dump(hs_3,f)
    # f.close()
    ...
    # f = open("./tpch_3_chain_5/q4_hs.pkl","wb")
    # pickle.dump(hs_4,f)
    # f.close()
    ...
    # f = open("./tpch_3_chain_5/q5_hs.pkl","wb")
    # pickle.dump(hs_5,f)
    # f.close()
    
    # hs_1 = pickle.load(open("./tpch_3_chain_5/q1_hs.pkl", "rb"))
    # hs_2 = pickle.load(open("./tpch_3_chain_5/q2_hs.pkl", "rb"))
    # hs_3 = pickle.load(open("./tpch_3_chain_5/q3_hs.pkl", "rb"))
    # hs_4 = pickle.load(open("./tpch_3_chain_5/q4_hs.pkl", "rb"))
    # hs_5 = pickle.load(open("./tpch_3_chain_5/q5_hs.pkl", "rb"))
    ...
    print(exact_time)
    exact_S.to_csv(r'./tpch_3_chain_5/exact_sample_10000.csv')
    with open('./tpch_3_chain_5/exact_time_10000.txt', 'w') as f:
    ...
    print(olken_time)
    olken_S.to_csv(r'./tpch_3_chain_5/olken_sample_10000.csv')
    with open('./tpch_3_chain_5/olken_time_10000.txt', 'w') as f:
    ...
    # olken_u_b_S.to_csv(r'./tpch_3_chain_5/olken_u_b_sample_1000000.csv')
    # with open('./tpch_3_chain_5/olken_u_b_time_1000000.txt', 'w') as f:
    ...
    # exact_u_b_S.to_csv(r'./tpch_3_chain_5/exact_u_b_sample_1000000.csv')
    # with open('./tpch_3_chain_5/exact_u_b_time_1000000.txt', 'w') as f:
